...
la $t0,label_32_v12
sw $t5,0($t0)
# Original instruction: li v13,12
li $t5,12
la $t0,label_33_v13
sw $t5,0($t0)
...
la $t0,label_52_v22
sw $t5,0($t0)
# Original instruction: li v23,12
li $t5,12
la $t0,label_53_v23
sw $t5,0($t0)
...
la $t0,label_72_v32
sw $t5,0($t0)
# Original instruction: li v33,12
li $t5,12
la $t0,label_73_v33
sw $t5,0($t0)
...
la $t0,label_106_v40
sw $t5,0($t0)
# Original instruction: lw v41,8($fp)
lw $t5,8($fp)
la $t0,label_95_v41
sw $t5,0($t0)
...
la $t0,label_92_v42
sw $t5,0($t0)
# Original instruction: li v43,12
li $t5,12
la $t0,label_93_v43
sw $t5,0($t0)
...
la $t0,label_126_v50
sw $t5,0($t0)
# Original instruction: lw v51,8($fp)
lw $t5,8($fp)
la $t0,label_115_v51
sw $t5,0($t0)
...
# Original instruction: addiu $sp,$sp,4
addiu $sp,$sp,4
# Original instruction: add v61,$v0,$zero
add $t5,$v0,$zero
la $t0,label_130_v61
sw $t5,0($t0)
# Original instruction: addiu v62,$fp,-32
addiu $t5,$fp,-32
la $t0,label_137_v62
sw $t5,0($t0)
...
la $t0,label_135_v64
sw $t5,0($t0)
# Original instruction: mul v65,v63,v64
la $t5,label_134_v63
lw $t5,0($t5)
la $t4,label_135_v64
lw $t4,0($t4)
...
la $t0,label_138_v65
sw $t3,0($t0)
# Original instruction: add v66,v62,v65
la $t5,label_137_v62
lw $t5,0($t5)
la $t4,label_138_v65
lw $t4,0($t4)
...
la $t0,label_151_v72
sw $t5,0($t0)
# Original instruction: addiu v73,$fp,-32
addiu $t5,$fp,-32
la $t0,label_158_v73
sw $t5,0($t0)
...
la $t0,label_155_v74
sw $t5,0($t0)
# Original instruction: li v75,12
li $t5,12
la $t0,label_156_v75
sw $t5,0($t0)
# Original instruction: mul v76,v74,v75
la $t5,label_155_v74
lw $t5,0($t5)
la $t4,label_156_v75
lw $t4,0($t4)
...
la $t0,label_159_v76
sw $t3,0($t0)
# Original instruction: add v77,v73,v76
la $t5,label_158_v73
lw $t5,0($t5)
la $t4,label_159_v76
lw $t4,0($t4)
...
la $t0,label_167_v80
sw $t3,0($t0)
# Original instruction: add v81,v77,v80
la $t5,label_166_v77
lw $t5,0($t5)
la $t4,label_167_v80
lw $t4,0($t4)
...
# Original instruction: syscall
syscall
# Original instruction: add v83,$zero,$zero
add $t5,$zero,$zero
la $t0,label_172_v83
sw $t5,0($t0)
...
la $t0,label_185_v90
sw $t5,0($t0)
# Original instruction: mul v91,v89,v90
la $t5,label_184_v89
lw $t5,0($t5)
la $t4,label_185_v90
lw $t4,0($t4)
...
la $t0,label_188_v91
sw $t3,0($t0)
# Original instruction: add v92,v88,v91
la $t5,label_187_v88
lw $t5,0($t5)
la $t4,label_188_v91
lw $t4,0($t4)
...
la $t0,label_192_v93
sw $t4,0($t0)
# Original instruction: add $a0,v93,$zero
la $t5,label_192_v93
lw $t5,0($t5)
add $a0,$t5,$zero
# Original instruction: li $v0,1
...
# Original instruction: syscall
syscall
# Original instruction: add v94,$zero,$zero
add $t5,$zero,$zero
la $t0,label_193_v94
sw $t5,0($t0)
...
la $t0,label_197_v96
sw $t5,0($t0)
# Original instruction: li v97,12
li $t5,12
la $t0,label_198_v97
sw $t5,0($t0)
# Original instruction: mul v98,v96,v97
la $t5,label_197_v96
lw $t5,0($t5)
la $t4,label_198_v97
lw $t4,0($t4)
...
la $t0,label_201_v98
sw $t3,0($t0)
# Original instruction: add v99,v95,v98
la $t5,label_200_v95
lw $t5,0($t5)
la $t4,label_201_v98
lw $t4,0($t4)
...
li $t5,0
la $t0,label_205_v100
sw $t5,0($t0)
# Original instruction: li v101,4
li $t5,4
la $t0,label_206_v101
sw $t5,0($t0)
# Original instruction: mul v102,v100,v101
la $t5,label_205_v100
lw $t5,0($t5)
la $t4,label_206_v101
lw $t4,0($t4)
mul $t3,$t5,$t4
la $t0,label_209_v102
sw $t3,0($t0)
# Original instruction: add v103,v99,v102
la $t5,label_208_v99
lw $t5,0($t5)
la $t4,label_209_v102
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_211_v103
sw $t3,0($t0)
# Original instruction: lw v104,0(v103)
la $t5,label_211_v103
lw $t5,0($t5)
lw $t4,0($t5)
...
add $t5,$zero,$zero
la $t0,label_214_v105
sw $t5,0($t0)
# Original instruction: addiu v106,$fp,-32
addiu $t5,$fp,-32
la $t0,label_221_v106
sw $t5,0($t0)
# Original instruction: li v107,1
li $t5,1
la $t0,label_218_v107
sw $t5,0($t0)
# Original instruction: li v108,12
li $t5,12
la $t0,label_219_v108
sw $t5,0($t0)
# Original instruction: mul v109,v107,v108
la $t5,label_218_v107
lw $t5,0($t5)
la $t4,label_219_v108
lw $t4,0($t4)
mul $t3,$t5,$t4
la $t0,label_222_v109
sw $t3,0($t0)
# Original instruction: add v110,v106,v109
la $t5,label_221_v106
lw $t5,0($t5)
la $t4,label_222_v109
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_229_v110
sw $t3,0($t0)
# Original instruction: li v111,1
li $t5,1
la $t0,label_226_v111
sw $t5,0($t0)
# Original instruction: li v112,4
li $t5,4
la $t0,label_227_v112
sw $t5,0($t0)
# Original instruction: mul v113,v111,v112
la $t5,label_226_v111
lw $t5,0($t5)
la $t4,label_227_v112
lw $t4,0($t4)
mul $t3,$t5,$t4
la $t0,label_230_v113
sw $t3,0($t0)
# Original instruction: add v114,v110,v113
la $t5,label_229_v110
lw $t5,0($t5)
la $t4,label_230_v113
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_232_v114
sw $t3,0($t0)
# Original instruction: lw v115,0(v114)
la $t5,label_232_v114
lw $t5,0($t5)
lw $t4,0($t5)
...
# Original instruction: syscall
syscall
# Original instruction: add v116,$zero,$zero
add $t5,$zero,$zero
la $t0,label_235_v116
sw $t5,0($t0)
# Original instruction: addiu v117,$fp,-32
addiu $t5,$fp,-32
la $t0,label_242_v117
sw $t5,0($t0)
# Original instruction: li v118,1
li $t5,1
la $t0,label_239_v118
sw $t5,0($t0)
# Original instruction: li v119,12
li $t5,12
la $t0,label_240_v119
sw $t5,0($t0)
# Original instruction: mul v120,v118,v119
la $t5,label_239_v118
lw $t5,0($t5)
la $t4,label_240_v119
lw $t4,0($t4)
mul $t3,$t5,$t4
la $t0,label_243_v120
sw $t3,0($t0)
# Original instruction: add v121,v117,v120
la $t5,label_242_v117
lw $t5,0($t5)
la $t4,label_243_v120
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_250_v121
sw $t3,0($t0)
# Original instruction: li v122,2
li $t5,2
la $t0,label_247_v122
sw $t5,0($t0)
# Original instruction: li v123,4
li $t5,4
la $t0,label_248_v123
sw $t5,0($t0)
# Original instruction: mul v124,v122,v123
la $t5,label_247_v122
lw $t5,0($t5)
la $t4,label_248_v123
lw $t4,0($t4)
mul $t3,$t5,$t4
la $t0,label_251_v124
sw $t3,0($t0)
# Original instruction: add v125,v121,v124
la $t5,label_250_v121
lw $t5,0($t5)
la $t4,label_251_v124
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_253_v125
sw $t3,0($t0)
# Original instruction: lw v126,0(v125)
la $t5,label_253_v125
lw $t5,0($t5)
lw $t4,0($t5)
...
# Original instruction: syscall
syscall
# Original instruction: add v127,$zero,$zero
add $t5,$zero,$zero
la $t0,label_256_v127
sw $t5,0($t0)
label_7_return_main:
# Original instruction: addiu $sp,$sp,32
addiu $sp,$sp,32
