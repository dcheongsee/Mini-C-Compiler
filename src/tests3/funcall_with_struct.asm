...
# Original instruction: addiu v30,$fp,-36
addiu $t5,$fp,-36
la $t0,label_87_v30
sw $t5,0($t0)
...
la $t0,label_71_v31
sw $t4,0($t0)
# Original instruction: sw v31,0($a0)
la $t5,label_71_v31
lw $t5,0($t5)
sw $t5,0($a0)
# Original instruction: lw v32,4(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,4($t5)
la $t0,label_74_v32
sw $t4,0($t0)
# Original instruction: sw v32,4($a0)
la $t5,label_74_v32
lw $t5,0($t5)
sw $t5,4($a0)
# Original instruction: lw v33,8(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,8($t5)
la $t0,label_77_v33
sw $t4,0($t0)
# Original instruction: sw v33,8($a0)
la $t5,label_77_v33
lw $t5,0($t5)
sw $t5,8($a0)
# Original instruction: lw v34,12(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,12($t5)
la $t0,label_80_v34
sw $t4,0($t0)
# Original instruction: sw v34,12($a0)
la $t5,label_80_v34
lw $t5,0($t5)
sw $t5,12($a0)
# Original instruction: lw v35,16(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,16($t5)
la $t0,label_83_v35
sw $t4,0($t0)
# Original instruction: sw v35,16($a0)
la $t5,label_83_v35
lw $t5,0($t5)
sw $t5,16($a0)
# Original instruction: lw v36,20(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,20($t5)
la $t0,label_86_v36
sw $t4,0($t0)
# Original instruction: sw v36,20($a0)
la $t5,label_86_v36
lw $t5,0($t5)
sw $t5,20($a0)
# Original instruction: lw v37,24(v30)
la $t5,label_87_v30
lw $t5,0($t5)
lw $t4,24($t5)
la $t0,label_89_v37
sw $t4,0($t0)
# Original instruction: sw v37,24($a0)
la $t5,label_89_v37
lw $t5,0($t5)
sw $t5,24($a0)
# Original instruction: addiu $sp,$sp,36
...
lw $t5,0($t5)
sw $t5,0($sp)
# Original instruction: li v39,454
li $t5,454
la $t0,label_93_v39
sw $t5,0($t0)
# Original instruction: addiu $sp,$sp,-4
...
la $t0,label_130_v45
sw $t5,0($t0)
# Original instruction: addiu v46,$fp,-36
addiu $t5,$fp,-36
la $t0,label_133_v46
sw $t5,0($t0)
# Original instruction: lw v47,0(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_108_v47
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: lw v48,4(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,4($t5)
la $t0,label_112_v48
sw $t4,0($t0)
# Original instruction: sw v48,4(v46)
la $t5,label_112_v48
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,4($t4)
# Original instruction: lw v49,8(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,8($t5)
la $t0,label_116_v49
sw $t4,0($t0)
# Original instruction: sw v49,8(v46)
la $t5,label_116_v49
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,8($t4)
# Original instruction: lw v50,12(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,12($t5)
la $t0,label_120_v50
sw $t4,0($t0)
# Original instruction: sw v50,12(v46)
la $t5,label_120_v50
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,12($t4)
# Original instruction: lw v51,16(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,16($t5)
la $t0,label_124_v51
sw $t4,0($t0)
# Original instruction: sw v51,16(v46)
la $t5,label_124_v51
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,16($t4)
# Original instruction: lw v52,20(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,20($t5)
la $t0,label_128_v52
sw $t4,0($t0)
# Original instruction: sw v52,20(v46)
la $t5,label_128_v52
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,20($t4)
# Original instruction: lw v53,24(v45)
la $t5,label_130_v45
lw $t5,0($t5)
lw $t4,24($t5)
la $t0,label_132_v53
sw $t4,0($t0)
# Original instruction: sw v53,24(v46)
la $t5,label_132_v53
lw $t5,0($t5)
la $t4,label_133_v46
lw $t4,0($t4)
sw $t5,24($t4)
# Original instruction: addiu v54,$fp,-36
addiu $t5,$fp,-36
la $t0,label_135_v54
sw $t5,0($t0)
# Original instruction: addiu v55,v54,0
la $t5,label_135_v54
lw $t5,0($t5)
addiu $t4,$t5,0
la $t0,label_137_v55
...
la $t0,label_142_v58
sw $t5,0($t0)
# Original instruction: addiu v59,v58,4
la $t5,label_142_v58
lw $t5,0($t5)
addiu $t4,$t5,4
la $t0,label_144_v59
...
# Original instruction: syscall
syscall
# Original instruction: add v61,$zero,$zero
add $t5,$zero,$zero
la $t0,label_147_v61
sw $t5,0($t0)
# Original instruction: addiu v62,$fp,-36
addiu $t5,$fp,-36
la $t0,label_149_v62
sw $t5,0($t0)
# Original instruction: addiu v63,v62,8
la $t5,label_149_v62
lw $t5,0($t5)
addiu $t4,$t5,8
la $t0,label_151_v63
...
la $t0,label_153_v64
sw $t4,0($t0)
# Original instruction: add $a0,v64,$zero
la $t5,label_153_v64
lw $t5,0($t5)
add $a0,$t5,$zero
# Original instruction: li $v0,1
...
# Original instruction: syscall
syscall
# Original instruction: add v65,$zero,$zero
add $t5,$zero,$zero
la $t0,label_154_v65
sw $t5,0($t0)
# Original instruction: addiu v66,$fp,-36
addiu $t5,$fp,-36
la $t0,label_156_v66
sw $t5,0($t0)
# Original instruction: addiu v67,v66,12
la $t5,label_156_v66
lw $t5,0($t5)
addiu $t4,$t5,12
la $t0,label_158_v67
...
la $t0,label_163_v70
sw $t5,0($t0)
# Original instruction: addiu v71,v70,16
la $t5,label_163_v70
lw $t5,0($t5)
addiu $t4,$t5,16
la $t0,label_165_v71
...
la $t0,label_170_v74
sw $t5,0($t0)
# Original instruction: addiu v75,v74,20
la $t5,label_170_v74
lw $t5,0($t5)
addiu $t4,$t5,20
la $t0,label_172_v75
...
la $t0,label_174_v76
sw $t4,0($t0)
# Original instruction: add $a0,v76,$zero
la $t5,label_174_v76
lw $t5,0($t5)
add $a0,$t5,$zero
# Original instruction: li $v0,1
...
# Original instruction: syscall
syscall
# Original instruction: add v77,$zero,$zero
add $t5,$zero,$zero
la $t0,label_175_v77
sw $t5,0($t0)
# Original instruction: addiu v78,$fp,-36
addiu $t5,$fp,-36
la $t0,label_177_v78
sw $t5,0($t0)
# Original instruction: addiu v79,v78,24
la $t5,label_177_v78
lw $t5,0($t5)
addiu $t4,$t5,24
la $t0,label_179_v79
