...
# orig beqz $t0,label_23_while_exit
...
# orig beqz $t0,label_25_while_exit
...
# orig beqz $t0,label_27_while_exit
...
# orig la $t0,global_final_result
...
# orig add $t0,$zero,$zero
add $t0,$zero,$zero
# orig la v148,str_572853306
# orig la $t0,str_572853306
la $t0,str_572853306
